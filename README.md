...
* Someone in charge who can configure your Worldcat instance to consume the REST service. WorldCat tries to `screenscrape`the html output rather then consume the xml or json format.
